...
- Removed Domain from entity examples and schema descriptions so it is no longer presented as a first-class catalog concept.

## [0.11.1] - 2026-09-15

### Changed

- Fixed support for defining properties of type `select` (Thank you to @shaun-mccormick-zocdoc!)
...
- A new `dx_entities` data source to list all entities of a given type from the catalog.
...
- Updated version in docs/README to latest.

## [0.5.0] - 2025-12-01

### Added

- Added support for managing entity types in DX with the `dx_entity_type` resource.
